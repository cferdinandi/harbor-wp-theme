...
<?php
	...
	$classes_social = $options['search'] === 'on' ? 'grid-two-thirds float-center' : 'grid-half grid-flip text-right-large';
	$classes_search = $has_facebook || $has_twitter || $has_youtube || $has_google || $has_instagram || $has_pinterest || $has_flickr ? 'grid-half text-left-large' : 'grid-two-thirds float-center';
?>

<?php if ( $has_facebook || $has_twitter || $has_youtube || $has_google || $has_instagram || $has_pinterest || $has_flickr || $options['search'] !== 'on' ) : ?>
	<div class="row">
		<div class="<?php echo $classes_social; ?>">
		...
		<?php if ( $options['search'] !== 'on' ) : ?>
			<div class="<?php echo $classes_search; ?>">
				<?php get_search_form(); ?>
			</div>
		<?php endif; ?>
	</div>
